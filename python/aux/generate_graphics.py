#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Time    : 2019-05-31 15:29
# @Author  : yuxuecheng
# @Contact : yuxuecheng@xinluomed.com
# @Site    : 
# @File    : generate_graphics.py
# @Software: PyCharm
# @Description
...
[features_1, labels_1, patient_num_beats_1] = load_mit_db('DS1', winL, winR, do_preprocess,
                                                          maxRR, use_RR, norm_RR, compute_morph, db_path, reduced_DS,
                                                          leads_flag)
...
plt.savefig('/Users/yuxuecheng/Learn/OpenSource/medicine/ecg-classification/graphic.pdf', dpi=None, facecolor='w', edgecolor='w',
