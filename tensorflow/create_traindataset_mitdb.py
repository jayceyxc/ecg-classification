...
def get_data_label_mitdb(list_patient, mit_db):
    ...
    for p in list_patient:
        ...
        for b in range(0, len(mit_db.classes[index]), 1):
            RR = [mit_db.temporal_features[index].pre_R[b], mit_db.temporal_features[index].post_R[b],
                  mit_db.temporal_features[index].local_R[b], mit_db.temporal_features[index].global_R[b]]
...
list_train_pat = [101, 106, 108, 109, 112, 114, 115, 116, 118, 119, 122, 124, 201, 203, 205, 207, 208, 209, 215, 220,
                  223, 230]
list_test_pat = [100, 103, 105, 111, 113, 117, 121, 123, 200, 202, 210, 212, 213, 214, 219, 221, 222, 228, 231, 232,
                 233, 234]
